...
import com.makemyshow.authentication.repository.PasswordResetTokenRepository;
import com.makemyshow.authentication.repository.UserRepository;
import com.makemyshow.authentication.repository.VerificationTokenRepository;
...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public User registerUser(UserRequestDTO userModel) {
        User user = new User();
